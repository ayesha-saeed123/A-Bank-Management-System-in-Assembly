...
; Enter to continue
etcin:
    mov ah, 00h     ; set BIOS function number for GetKeyboardInput
    int 16h         ; call BIOS interrupt 16h to read a character
    cmp al, 0Dh     ; check if the character is a carriage return (13 decimal)
    je mainloop     ; jump to mainloop if true
    jmp etcin       ; otherwise, continue reading characters
ret
